...
import DSOUserCreateModal from "./Create";
import DSOUserEditModal from "./Edit";
import DSOUserViewModal from "./View";
...
const DSOUserList: React.FC = () => {
  ...
  const handleDeleteClick = async (row: any) => {
    ...
    if (result.isConfirmed) {
      await DSOUserService.delete(row.id);
      refreshTable();
  ...
  return (
    <>
      <KiduServerTableList
        key={tableKey}
        title="DSO Users"
        subtitle="Manage DSO user master data"
        columns={columns}
        paginatedFetchService={DSOUserService.getPaginatedList}
        rowKey="id"
        showAddButton={true}
